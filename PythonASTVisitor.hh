...
struct TargetedASTVisitor : RecursiveASTVisitor {
  TargetedASTVisitor(int64_t target_function_id, int64_t target_split_id);

  int64_t target_function_id;
  int64_t target_split_id;
  int64_t current_function_id;
  int64_t current_split_id;

  virtual bool within_target() const;
