...
static map<string, Variable> globals({
  ...
  {"api_version",          Variable(ValueType::Int, static_cast<int64_t>(0))},
  ...
  // {"getsizeof",            Variable()},
  // {"hash_info",            Variable()},
  {"hexversion",           Variable(ValueType::Int, static_cast<int64_t>(0))},
  // {"implementation",       Variable()},
  // {"int_info",             Variable()},
  // {"last_traceback",       Variable()},
  // {"last_type",            Variable()},
  // {"last_value",           Variable()},
  {"maxsize",              Variable(ValueType::Int, static_cast<int64_t>(0x7FFFFFFFFFFFFFFFLL))},
  {"maxunicode",           Variable(ValueType::Int, static_cast<int64_t>(0x10FFFFLL))},
  // {"modules",              Variable()},
  // {"path",                 Variable()},
  // {"platform",             Variable()},
  // {"prefix",               Variable()},
